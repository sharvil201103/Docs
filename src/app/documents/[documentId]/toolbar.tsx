...
const LinkButton = () => {
    ...
    return (<DropdownMenu onOpenChange={(open)=>{ if(open){
            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
                {
                    headings.map(({
                        ...
                        <button
                            ...
                            className={
                                cn(
                                    "flex items-center gap-x-2 px-2 py-1 rounded-sm hiver:bg-neutral-200/80",
